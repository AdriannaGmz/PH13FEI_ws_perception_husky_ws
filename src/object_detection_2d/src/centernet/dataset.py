...
def reverse_res_to_bbox(res):
    ...
    print(down_ratio)
    output_h, output_w =  res['hm'].shape[1],  res['hm'].shape[2]
...
class ctDataset(data.Dataset):
    ...
    def __init__(self, dataset="Kitti"):
        ...
        #train_label_dir = '/home/venkatea/centernet/data/kitti/training/label_2/'
        train_label_dir = '/export/amsvenkat/isa_data/run_1_mix/fine_tune/label/'
        #train_label_dir = '/home/venkatea/isa_data/run_2_nomix/new_fine_tune/label/'

        #train_label_dir = '/home/venkatea/centernet/data/kitti/training/label_2/'


        train_image_dir = '/export/amsvenkat/isa_data/run_1_mix/fine_tune/image/'
        #train_image_dir = '/home/venkatea/isa_data/run_2_nomix/new_fine_tune/image/'
        #train_image_dir = '/home/venkatea/centernet/data/kitti/training/image_2/'



        #train_calib_dir = '/home/venkatea/centernet/data/kitti/training/calib/'
    ...
    def __getitem__(self, index):
        ...
        image_path, label_path = self.df_in_list_[index]

        # get the image (375, 1242, 3)
        img = cv2.imread(image_path) 
        if self.dataset == "Kitti":
            default_resolution = [375, 1242]
            scaled_resolution = [384, 1248]
        elif self.dataset == "ISA":
            scaled_resolution = default_resolution = [384, 512]
        
        #print(f"what is read  {img.shape}" )
        # height, width = img.shape[0], img.shape[1]  
        # print("Before pre-reshape: ", , width)
        ...
        sc_h, sc_w = scaled_resolution[0]/default_resolution[0], scaled_resolution[1]/default_resolution[1]
        ...
        count = 0
        # enumerating no of objects in the file
        for c in content:
            if (c[0] in ["Car", "Pedestrian", "car", "pedestrian"]):
...
if __name__ == "__main__":
    im_idx =4
    my_dataset = ctDataset(dataset="ISA")
